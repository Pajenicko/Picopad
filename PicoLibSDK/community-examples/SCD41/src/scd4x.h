...
public:
    ...
    bool begin(uint8_t i2cInst = 0, bool measBegin = true, bool autoCalibrate = true, bool skipStopPeriodicMeasurements = false, bool pollAndSetDeviceType = true); //By default use Wire port
    ...
    bool stopPeriodicMeasurement(uint16_t delayMillis = 500, uint8_t i2cInst = 0);
