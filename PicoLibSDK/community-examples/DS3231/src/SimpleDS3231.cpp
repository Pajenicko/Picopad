...
void SimpleDS3231::_read_data_reg(uint8_t reg, uint8_t n_regs)
{
    ...
    i2c_write_blocking_until(i2c0, DS3231_ADDR, _data_buffer, 1, true, timeout);
    i2c_read_blocking_until(i2c0, DS3231_ADDR, _data_buffer + reg + 1, n_regs, false, timeout);
}
...
void SimpleDS3231::_write_data_reg(uint8_t reg, uint8_t n_regs)
{
    ...
    i2c_write_blocking_until(i2c0, DS3231_ADDR, buffer, n_regs + 1, false, timeout);
}
...
uint8_t SimpleDS3231::get_temp()
{
    ...
    i2c_write_blocking_until(i2c0, DS3231_ADDR, _data_buffer, 1, true, timeout);
    i2c_read_blocking_until(i2c0, DS3231_ADDR, &temp, 1, false, timeout);
